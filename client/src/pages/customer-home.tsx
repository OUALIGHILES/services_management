  ...
  return (
    <div className="space-y-12 pb-12">
      ...
      <section>
        ...
        >
          <h3 className="text-2xl font-black font-display bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent">
            Recent Orders
          </h3>
          <Link href="/customer/orders">
            <Button variant="outline" size="sm" className="font-semibold hover:scale-105 transition-transform">
              View All
        ...
        {orders?.length === 0 ? (
          <motion.div
            ...
            transition={{ delay: 0.6 }}
          >
            <Card className="bg-gradient-to-br from-muted/30 to-purple-50/20 border-dashed border-2 hover:border-purple-300 transition-all">
              <CardContent className="flex flex-col items-center justify-center py-16 text-center">
                <motion.div
                  animate={{ y: [0, -10, 0] }}
                  transition={{ duration: 2, repeat: Infinity }}
                  className="w-20 h-20 bg-gradient-to-br from-purple-100 to-indigo-100 rounded-full flex items-center justify-center mb-6 shadow-lg"
                >
                ...
                <Link href="/customer/book">
                  <Button className="mt-6 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 shadow-lg hover:shadow-xl hover:scale-105 transition-all">
                    Book Now
                    <ArrowRight className="ml-2 w-4 h-4" />
                  </Button>
                </Link>
          ...
          <div className="grid gap-4">
            {orders?.slice(0, 3).map((order, index) => (
              ...
              >
                <Card className="hover:shadow-2xl transition-all duration-300 border-2 hover:border-purple-200 overflow-hidden group">
                  <CardContent className="p-6 bg-gradient-to-r from-white to-purple-50/10 group-hover:to-purple-50/30 transition-all">
                    <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
                      <div className="space-y-3 flex-1">
                        <div className="flex items-center gap-3 flex-wrap">
                          <span className="font-mono text-sm font-bold text-purple-600 bg-purple-50 px-3 py-1 rounded-full">
                            {order.requestNumber}
                          </span>
                        ...
                        <div className="flex flex-col gap-2 mt-3">
                          ...
                          >
                            <div className="w-3 h-3 bg-green-500 rounded-full mr-3 shadow-lg shadow-green-500/50" />
                          ...
                          <motion.div
                            ...
                            className="flex items-center text-sm"
                          >
                            <div className="w-3 h-3 bg-red-500 rounded-full mr-3 shadow-lg shadow-red-500/50" />
                      ...
                      <div className="flex items-center gap-6 text-sm">
                        ...
                        {order.totalAmount && (
                          <motion.div
                            ...
                            className="font-black text-2xl bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent"
                          >
                            ${order.totalAmount}
                          </motion.div>
                        )}
